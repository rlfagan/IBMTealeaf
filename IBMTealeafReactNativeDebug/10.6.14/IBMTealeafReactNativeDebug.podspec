Pod::Spec.new do |s|
  ...
  s.platforms = { :ios => "9.0" }
  s.source = { :git => 'https://github.com/ibm-watson-cxa/IBMTealeaf.git', :tag => '10.6.13'}
  ...
  s.subspec 'MD5' do |md5|
    md5.dependency 'IBMTealeafReactNativeDebug/Core'
    md5.dependency 'TealeafMD5Debug'
  end
  s.subspec 'SHA512' do |sha512|
    sha512.dependency 'IBMTealeafReactNativeDebug/Core'
